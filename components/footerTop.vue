<template>
  ...
  >
    ...
    <!--                &lt;!&ndash;                    <v-icon> mdi-phone </v-icon>&ndash;&gt;-->
    <!--                &lt;!&ndash;                  </v-list-item-icon>&ndash;&gt;-->

    <!--                &lt;!&ndash;                  <v-list-item-content>&ndash;&gt;-->
    <!--                &lt;!&ndash;                    <v-list-item-title>PHONE</v-list-item-title>&ndash;&gt;-->
    <!--                &lt;!&ndash;                    <v-list-item-subtitle>(323) 555-6789</v-list-item-subtitle>&ndash;&gt;-->
    <!--                &lt;!&ndash;                    <v-list-item-subtitle>(650) 555-1234</v-list-item-subtitle>&ndash;&gt;-->
    <!--                &lt;!&ndash;                  </v-list-item-content>&ndash;&gt;-->
    <!--                &lt;!&ndash;                </v-list-item>&ndash;&gt;-->
    <!--                <v-divider></v-divider>-->
    <!--              </v-list>-->
